<template lang="">
  <v-form v-on:submit.prevent="store.EditElectric(Electric0, Electric50,Electric100, Electric200, Electric300, Electric400);store.AlertSuccess = true">
    <v-card-text>        
        ...
        <v-text-field label="Trên 400 Kw" variant="outlined" v-model="Electric400"></v-text-field>        
    </v-card-text>  
    <v-card-actions>      
...
export default {
    ...
    data() {
        return {            
            ...
            Electric400:store.service[0].Electric400,
        }
    },
};
</script>
